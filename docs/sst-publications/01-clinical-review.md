...
- A concussion rehabilitation app (*Rhea*) already delivers heart-rate-targeted aerobic prescription, guiding users to a percentage of their **age-predicted maximal heart rate** (*JMIR Formative Research*, 11 Apr 2025); an RCT has likewise delivered early aerobic exercise using a **progressive percentage of age-predicted-max HR** (*PLOS One*, 2022).
...
- The pivotal Buffalo trials themselves delivered individualised HRt-based home exercise with **wearable HR monitoring** (80% of HRt with a Polar monitor, *JAMA Pediatr.* 2019; serial-HRt-updated prescription with weekly BCTT recheck, *Lancet Child Adolesc Health* 2021).
- A **commercial** concussion exercise-prescription module exists and is reaching Australia: the CCMI + Wibbi partnership (Dec 2025) embeds concussion protocols in a digital home-exercise-program platform with outcome tracking.

Against that backdrop, the defensible contribution is *not* "first digital delivery." It is narrower: **to our knowledge, no published tool combines a fail-closed heart-rate-verification engine that refuses to fabricate a reading + hardware-agnostic, clinician-supervised, BCTT-derived-HRt (not age-predicted-max) delivery as a single standardised workflow.** The verification architecture and the BCTT-HRt anchor — not the use of heart rate or the fact of an app — are the claim.
