 ...
 * (Chartered Association of Sport & Exercise Sciences). Angle: CPD endorsement
 * of the rehab-exercise concussion course. Interest capture only while the
...
export default function CasesLandingPage() {
  return (
      ...
      <main className="max-w-3xl mx-auto px-5 py-14 sm:py-20">
        ...
        <section>
          <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-teal-700">
            For CASES sport &amp; exercise scientists
          </p>
          <h1 className="mt-3 text-3xl sm:text-[2.6rem] font-extrabold tracking-tight leading-[1.1]">
            The graded exercise test you already run just became first-line
            concussion treatment.
          </h1>
          <p className="mt-5 text-[15px] leading-relaxed text-slate-600">
            <strong className="text-slate-900">Concussion Rehab Mastery</strong> is
            a structured, evidence-led rehab-exercise course for sport and exercise
            scientists — eight hours of CPD, shipped with the clinical tools to
        ...
        <section className="mt-14 rounded-2xl border border-slate-200 bg-slate-50 p-6 sm:p-7">
          ...
          <p className="mt-3 text-[15px] leading-relaxed text-slate-700">
            Deriving and progressing an individualised HR threshold from a graded
            test is core sport-and-exercise-science practice. What changed is not
            the skill — it is the <strong>indication</strong>.
          </p>
        ...
        <section className="mt-14">
          ...
          <p className="mt-2 text-[14px] text-slate-600">
            ...
            {CRM_REFERENCE_COUNT} peer-reviewed references · self-paced · lifetime access.
          </p>
        ...
        <section id="register" className="mt-14 scroll-mt-8">
          <EpLeadCapture variant="full" location="cases" />
        </section>
