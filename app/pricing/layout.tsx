...
export const metadata: Metadata = {
  ...
  description: 'Enrol in Australia\'s most comprehensive concussion management course. Online course $497 AUD (8 CPD hours) or Complete Course from $1,190 early-bird (14 CPD hours including full-day workshop). AHPRA aligned, endorsed by Osteopathy Australia. For physios, osteos, chiros & GPs.',
  ...
  openGraph: {
    ...
    description: 'Online course $497 AUD (8 CPD hours) or Complete Course from $1,190 early-bird (14 CPD hours). AHPRA aligned.',
    type: 'website',
