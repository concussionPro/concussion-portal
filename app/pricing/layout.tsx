...
export const metadata: Metadata = {
  ...
  description: 'Enrol in Australia\'s most comprehensive concussion management course. Online course $497 AUD (8 CPD points) or Complete Course $1,190 AUD (14 CPD points including full-day workshop). AHPRA aligned, endorsed by Osteopathy Australia. For physios, osteos, chiros & GPs.',
