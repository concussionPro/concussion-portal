...
export async function GET(req: NextRequest) {
  ...
  // Returns 302 → CDN-cached PNG. Fetch and stream the bytes back.
  ...
  microlinkUrl.searchParams.set('viewport.width', '1440')
  microlinkUrl.searchParams.set('viewport.height', '900')
  microlinkUrl.searchParams.set('waitForTimeout', '2500')
  microlinkUrl.searchParams.set('meta', 'false')
  microlinkUrl.searchParams.set('type', 'png')
