        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8 py-6 sm:py-8">
          ...
          <div className="glass-premium rounded-2xl p-4 mt-6 text-center">
            <p className="text-xs text-muted-foreground">
              Modules 2-8 unlock for every {CLINIC.shortName} clinician with the Hub Program · 8 CPD hrs online across the course (16 with the in-person day) · AHPRA-aligned.
            </p>
          </div>
        </div>
      </main>
