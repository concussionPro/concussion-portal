  ...
  return (
    <>
      ...
      <div className="min-h-screen relative">
        ...
        {/* HERO - Compact */}
        <section className="section-padding pt-72 md:pt-80 pb-12 relative z-10">
          ...
          <div className="container-md px-6 md:px-8 relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-4 max-w-4xl mx-auto">
              <div className="glass rounded-xl p-6">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-teal-500 flex items-center justify-center text-white text-xs font-bold">A</div>
                  <div>
                    <div className="text-sm font-bold">Andy</div>
                    <div className="text-xs text-muted-foreground">Clinic Owner, NSW</div>
                  </div>
                </div>
              </div>
              <div className="glass rounded-xl p-6">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-teal-500 to-emerald-500 flex items-center justify-center text-white text-xs font-bold">D</div>
                  <div>
                    <div className="text-sm font-bold">Dean</div>
                    <div className="text-xs text-muted-foreground">University Clinical Educator, QLD</div>
                  </div>
                </div>
              </div>
            </div>
