...
/**
 * /cata — the CATA Approved Provider landing page (see layout.tsx for the
...
export const metadata = {
  alternates: { canonical: '/cata' },
}

export default async function CanadaLandingPage() {
  // Same auto-currency model as /uk: the price the visitor sees is the price
  // their geo is charged (CA → CA$475 via lib/international-pricing).
