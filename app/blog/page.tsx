...
const blogPosts: Array<{
  ...
  {
    title: "AHPRA AI Guidelines Explained: What Australian Clinicians Actually Need to Do [2026]",
    description: 'AHPRA AI guidelines decoded — the 4 obligations every AU clinician must meet when using AI in patient care. Patient consent, clinician responsibility, data location, and documentation integrity.',
    date: 'May 27, 2026',
  ...
  {
    title: "Can I Use ChatGPT for NDIS Reports? An Australian Allied Health Compliance Guide [2026]",
    description: 'Can you use ChatGPT for NDIS reports? Privacy Act exposure, NDIA audit risk, and the safe alternatives (Heidi, Lyrebird) for AU allied health practitioners.',
    date: 'May 27, 2026',
