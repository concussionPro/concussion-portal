      ...
      <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <section className="bg-gradient-to-br from-rose-700 to-pink-700 text-white rounded-xl p-8 mb-8">
            ...
            <p className="text-rose-100 leading-relaxed mb-5">The forthcoming PPCS Clinical Mastery course covers cervical assessment + treatment alongside vestibulo-ocular, autonomic, and headache workups. Worked clinical scenarios, structured assessment templates, escalation pathways. Target launch August 2026.</p>
