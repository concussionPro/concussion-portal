...
export const metadata: Metadata = {
  ...
  description: 'FREE 2-hour SCAT6 & SCOAT6 training course. Master concussion assessment with fillable PDFs, step-by-step training, and clinical toolkit. 2 AHPRA CPD points.',
  ...
  openGraph: {
    ...
    description: 'Master SCAT6 & SCOAT6 concussion assessment. FREE 2-hour course with fillable PDFs, training modules, and 2 CPD points.',
    type: 'website',
