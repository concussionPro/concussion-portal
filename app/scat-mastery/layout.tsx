...
export const metadata: Metadata = {
  title: 'Free SCAT6/SCOAT6 Mastery Course | 2 CPD Points | Fillable PDFs Included',
  description: 'FREE ~3-hour SCAT6 & SCOAT6 training course. Master concussion assessment with fillable PDFs, step-by-step training, and clinical toolkit. 2 AHPRA CPD points.',
  ...
  openGraph: {
    ...
    description: 'Master SCAT6 & SCOAT6 concussion assessment. FREE ~3-hour course with fillable PDFs, training modules, and 2 CPD points.',
    type: 'website',
  ...
  twitter: {
    ...
    description: 'FREE concussion assessment training. Fillable PDFs, 2 CPD points, step-by-step SCAT6 & SCOAT6 instruction.',
  },
  alternates: {
