    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-3xl mx-auto px-6 pt-[120px] pb-20">
        ...
        <div className="rounded-2xl border-4 border-double border-slate-300 bg-white p-10 mb-8 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-8">Aligned with AHPRA&apos;s 2025 AI Code of Conduct, Australian Privacy Principles, and TGA Therapeutic Goods Advertising Code</p>
