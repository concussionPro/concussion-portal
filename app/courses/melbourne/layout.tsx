...
export const metadata: Metadata = {
  ...
  description: 'Full-day hands-on concussion workshop in Melbourne. Master SCAT6, VOMS, and BESS protocols with expert-led clinical training. 14 AHPRA CPD points (8 online + 6 in-person). Next round Jun-Aug 2026.',
