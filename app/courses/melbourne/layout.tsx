...
export const metadata: Metadata = {
  ...
  description: 'Full-day hands-on concussion workshop in Melbourne. Master SCAT6, VOMS, and BESS protocols with expert-led clinical training. Up to 16 CPD hours (8 online + 8 in-person). Melbourne workshop delivered June 2026 — nominate for the next round.',
