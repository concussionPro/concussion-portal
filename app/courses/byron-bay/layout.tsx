...
export const metadata: Metadata = {
  ...
  description: 'Full-day hands-on concussion workshop in Byron Bay. Master SCAT6, VOMS, and BESS protocols with expert-led clinical training. 14 AHPRA CPD hours (8 online + 6 in-person). Next round Jun-Aug 2026.',
  ...
  openGraph: {
    ...
    description: 'Full-day hands-on concussion training in Byron Bay. Master SCAT6, VOMS, BESS protocols. 14 AHPRA CPD hours.',
    type: 'website',
