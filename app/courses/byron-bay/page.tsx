...
export default function ByronBayPage() {
  const location = CONFIG.LOCATIONS.BYRON_BAY

  return (
    <>
      {/* Schema Markup for SEO */}
      <EventSchema location="BYRON_BAY" />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            {location.status === 'confirmed' ? (
              <>
                ...
                <a
                  href={`${CONFIG.SHOP_URL}?location=byron-bay`}
                  ...
                  aria-label={`Enrol in Byron Bay session for $${CONFIG.COURSE.PRICE_REGULAR.toLocaleString()}`}
                >
              ...
              <div className="inline-flex items-center gap-2 bg-amber-50 border border-amber-200 text-amber-800 px-5 py-2.5 rounded-full text-sm font-semibold">
                ...
                Byron Bay date to be confirmed — register your interest below
              </div>
            )}
          </div>
          ...
          <div className="glass rounded-2xl p-8 text-center bg-gradient-to-br from-blue-600/5 to-teal-600/5">
            ...
            <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
              Join Byron Bay clinicians mastering evidence-based concussion management.{location.status === 'confirmed' ? ` Workshop date confirmed — limited spots for optimal hands-on practice.` : ` Reserve your spot now — dates confirmed once ${CONFIG.WORKSHOP.CONFIRMATION_THRESHOLD} registrants per city are locked in.`}
            </p>
