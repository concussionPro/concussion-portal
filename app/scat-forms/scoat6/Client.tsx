...
export default function SCOAT6Client() {
    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200">
        ...
        <div className="p-8 space-y-6">
          ...
          <SectionHeader id="currentInjury" title="Current Injury & History" expandedSections={expandedSections} toggleSection={toggleSection}>
          ...
          <SectionHeader id="medications" title="Medications & Family History" expandedSections={expandedSections} toggleSection={toggleSection}>
            <div className="space-y-6">
              {/* Medications */}
              <div>
          ...
          <SectionHeader id="symptoms" title="Symptom Evaluation" expandedSections={expandedSections} toggleSection={toggleSection}>
          ...
          <SectionHeader id="cognitive" title="Verbal Cognitive Tests" expandedSections={expandedSections} toggleSection={toggleSection}>
            <div className="space-y-6">
              {/* Immediate Memory */}
              <div>
                <h4 className="font-bold text-slate-900 mb-3 bg-green-50 border border-green-300 px-3 py-2 rounded">
          ...
          <SectionHeader id="examination" title="Physical Examination" expandedSections={expandedSections} toggleSection={toggleSection}>
            <div className="space-y-6">
          ...
          <SectionHeader id="complexGait" title="Complex & Dual Task Gait" expandedSections={expandedSections} toggleSection={toggleSection}>
            <div className="space-y-6">
              {/* Complex Tandem Gait */}
              <div>
                <h4 className="font-bold text-slate-900 mb-3 bg-orange-50 border border-orange-300 px-3 py-2 rounded">
          ...
          <SectionHeader id="mvoms" title="mVOMS & Mental Health Screens" expandedSections={expandedSections} toggleSection={toggleSection}>
            <div className="space-y-6">
              {/* mVOMS */}
              <div>
                <h4 className="font-bold text-slate-900 mb-3 bg-green-50 border border-green-300 px-3 py-2 rounded">
          ...
          <SectionHeader id="delayedRecall" title="Delayed Recall & Additional Tests" expandedSections={expandedSections} toggleSection={toggleSection}>
            <div className="space-y-6">
              {/* Delayed Word Recall */}
              <div>
                <h4 className="font-bold text-slate-900 mb-3 bg-green-50 border border-green-300 px-3 py-2 rounded">
          ...
          <SectionHeader id="assessment" title="Overall Assessment & Management" expandedSections={expandedSections} toggleSection={toggleSection}>
            <div className="space-y-6">
          ...
          <SectionHeader id="finalNotes" title="Additional Notes & HCP Information" expandedSections={expandedSections} toggleSection={toggleSection}>
            <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-green-50 to-cyan-50 border-2 border-green-300 rounded-xl p-6">
            ...
            <div className="mt-4 pt-4 border-t border-green-200">
              <p className="text-xs text-slate-500">
                All auto-calculations working. Auto-save enabled. Colors match PDFs.
              </p>
            </div>
          </div>
          ...
          {/* SCAT6 & SCOAT6 Mastery Upsell */}
          <div className="mt-6 p-4 bg-teal-50 border border-teal-200 rounded-xl text-center">
            <p className="text-sm font-semibold text-slate-900 mb-1">Want to master the SCOAT6?</p>
