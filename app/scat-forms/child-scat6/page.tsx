        ...
        <div className="p-8 space-y-6">
          ...
          <SectionHeader id="childSymptoms" title="Child Symptom Report (0-3 Scale)" expandedSections={expandedSections} toggleSection={toggleSection}>
            <div className="space-y-2">
              ...
              {/* Header row */}
              <div className="grid grid-cols-[1fr,repeat(4,56px)] gap-1 mb-2 text-center">
                <div></div>
              ...
              {childSymptomLabels.map(({ key, label }) => (
                <div key={key} className="grid grid-cols-[1fr,repeat(4,56px)] gap-1 items-center py-1 border-b border-slate-100">
