  ...
  return (
    <div className="hidden md:flex fixed left-0 top-0 h-screen w-64 sidebar-premium p-6 flex-col z-40">
      ...
      <nav className="flex-1 space-y-1">
        ...
        <SidebarItem href={`${portalBase}/learning?${ak}`} label="Learning Suite" icon={BookOpen} />
        ...
        <SidebarItem href={`${portalBase}/references?${ak}`} label="Reference Library" icon={Library} active />
