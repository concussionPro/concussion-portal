...
export const metadata: Metadata = {
  ...
  description: 'Full-day hands-on concussion workshop. Master SCAT6 administration, VOMS testing, BESS protocols, and vestibular assessment. 6 AHPRA CPD hours. Limited to 12 participants. Sydney, Melbourne, Byron Bay.',
