...
export const metadata: Metadata = {
  title: 'Concussion Management Course | 16 CPD Hours | Online + Practical',
  description: 'Australia\'s most comprehensive concussion management course. 8 online modules (8 CPD hours) plus full-day hands-on workshop (8 CPD hours). AHPRA aligned, endorsed by Osteopathy Australia. Evidence-based training for physiotherapists, osteopaths, chiropractors, and GPs.',
  ...
  openGraph: {
    title: 'Concussion Management Course — 16 CPD Hours',
