...
export const metadata: Metadata = {
  ...
  description: 'Australia\'s most comprehensive concussion management course. 8 online modules (8 CPD points) plus full-day hands-on workshop (6 CPD points). AHPRA aligned, endorsed by Osteopathy Australia. Evidence-based training for physiotherapists, osteopaths, chiropractors, and GPs.',
