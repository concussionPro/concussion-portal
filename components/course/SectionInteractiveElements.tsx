...
import { QuickCheck, ClinicalInsight, KeyConcept, Flowchart, ClinicalScenario, OrderingExercise, MatchingExercise, MultiSelectQuiz } from '@/components/course/InteractiveElements'
...
export function SectionInteractiveElements({ moduleId, section, sectionIndex }: SectionInteractiveElementsProps) {
  return (
    <>
      ...
      {moduleId === 1 && section.id === 'myths-intro' && (
        <>
          <QuickCheck
            ...
            options={["About 50%", "About 30%", "About 10%", "Nearly all"]}
            correctAnswer={2}
          ...
          <QuickCheck
            ...
            options={["No concussion occurred", "Structural damage has been ruled out, but concussion is still possible", "An MRI is needed to confirm", "The player can return to the field"]}
            correctAnswer={1}
          ...
          <QuickCheck
            ...
            options={["The 14-year-old (younger brain heals faster)", "The 30-year-old (adult brains are more resilient)", "Recovery time is identical regardless of age", "It depends entirely on fitness level"]}
            correctAnswer={1}
          ...
          <QuickCheck
            ...
            options={["Professional athletes", "Children in contact sports", "Older adults (falls)", "Military personnel"]}
            correctAnswer={2}
          ...
          <QuickCheck
            ...
            options={["Complete bed rest for 2 weeks", "24-48 hours relative rest, then gradual return to activity", "No rest — return to normal immediately", "Complete rest until all symptoms resolve"]}
            correctAnswer={1}
          ...
          <QuickCheck
            ...
            options={["They prevent rotational forces that cause concussion", "They absorb all impact energy before it reaches the brain", "They reduce skull fracture risk but cannot prevent concussion", "They are equally effective against all concussion mechanisms"]}
            correctAnswer={2}
          ...
          <QuickCheck
            ...
            options={["Clear them for full return to sport immediately", "Begin a graduated return-to-activity protocol with medical oversight", "Wait another 2 weeks of rest before any activity", "Order an MRI to confirm recovery"]}
            correctAnswer={1}
          ...
          <QuickCheck
            ...
            options={["Only cognitive (memory, concentration)", "Cognitive and physical only", "Cognitive, emotional, physical, and sleep", "Only physical (headache, dizziness)"]}
            correctAnswer={2}
          ...
          <QuickCheck
            ...
            options={["No — concussion requires direct head-to-head contact", "No — heading is too low-force to cause concussion", "Yes — rotational forces from heading can cause concussion without direct contact", "Only if they have a history of prior concussions"]}
            correctAnswer={2}
          ...
          <QuickCheck
            ...
            options={["The injury is too small to detect", "Concussion is a functional (metabolic) disturbance, not a structural one", "CT and MRI technology is outdated", "The scan was done too early after injury"]}
            correctAnswer={1}
      ...
      {moduleId === 1 && section.id === 'introduction' && (
        <>
          <ClinicalInsight
            type="tip"
            ...
            steps={[
              {
                ...
                clinicalData: ['Mechanism: shoulder-to-chest tackle (no visible head contact)', 'Observed: stumbled, looked confused for ~10 seconds', 'No loss of consciousness', 'Player self-reports feeling fine'],
                choices: [
                  { label: 'Yes — concussion is possible', nextStepId: 'step-2' },
                  { label: 'No — there was no head contact', nextStepId: 'outcome-no-contact' },
                  { label: 'Need more information', nextStepId: 'outcome-more-info' },
                ],
              },
              {
                id: 'step-2',
                narrative: 'What should happen next?',
                clinicalData: ['Suspected concussion based on observed confusion after forceful tackle', 'No red flags (no LOC, no seizure, no focal deficit)', 'Player wants to continue playing'],
                choices: [
                  { label: 'Remove from play and assess with SCAT6', nextStepId: 'step-3' },
                  { label: 'Let him continue if symptoms resolve in 5 minutes', nextStepId: 'outcome-continue' },
                  { label: 'Send directly to emergency department', nextStepId: 'outcome-ed' },
                ],
              },
              {
                id: 'step-3',
                narrative: 'If the SCAT6 is normal 20 minutes later, can the athlete return to play today?',
                clinicalData: ['SCAT6 assessment completed — results within normal limits', '20 minutes since removal from play', 'Player asymptomatic and eager to return'],
                choices: [
                  { label: 'Yes — normal SCAT6 clears the athlete', nextStepId: 'outcome-cleared' },
                  { label: 'No — same-day return is never permitted after suspected concussion', nextStepId: 'outcome-optimal' },
                  { label: 'Only if a doctor approves', nextStepId: 'outcome-doctor' },
                ],
              },
              {
                ...
                narrative: '',
                choices: [],
                outcome: { type: 'suboptimal', title: 'Incorrect — Head Contact Not Required', explanation: 'Direct head contact is NOT required for concussion. Rotational and acceleration-deceleration forces transmitted through the body can cause concussion — this is a key mechanism in tackles and whiplash injuries.', clinicalReasoning: 'The shoulder-to-chest tackle transmits rapid deceleration forces through the cervical spine to the head, producing rotational acceleration of the brain within the skull. The observed confusion is a clear sign of neurological dysfunction consistent with concussion.' },
              },
              {
                ...
                narrative: '',
                choices: [],
                outcome: { type: 'acceptable', title: 'Caution Is Reasonable — But Action Is Needed Now', explanation: 'While gathering more information is understandable, the observed confusion after a forceful tackle already meets the threshold for suspected concussion. Direct head contact is NOT required — rotational and acceleration-deceleration forces transmitted through the body can cause concussion.', clinicalReasoning: 'The Amsterdam 2022 Consensus is clear: "If in doubt, sit them out." Visible confusion after a forceful mechanism is sufficient to trigger the concussion protocol. Waiting for more information delays removal from play.' },
              },
              {
                id: 'outcome-continue',
                isOutcome: true,
                narrative: '',
                choices: [],
                outcome: { type: 'suboptimal', title: 'Against Guidelines', explanation: 'Any athlete with suspected concussion must be immediately and permanently removed from play on that day. A structured assessment like the SCAT6 should follow.', clinicalReasoning: 'Allowing continued play with suspected concussion risks second impact syndrome and prolonged recovery. Symptoms can fluctuate — a 5-minute window of symptom resolution does not indicate recovery.' },
              },
              {
                id: 'outcome-ed',
                isOutcome: true,
                narrative: '',
                choices: [],
                outcome: { type: 'acceptable', title: 'Overly Cautious', explanation: 'Any athlete with suspected concussion must be immediately and permanently removed from play on that day. A structured assessment like the SCAT6 should follow. Emergency department referral is indicated for red flags (prolonged LOC, seizure, worsening symptoms, focal deficits) — not for uncomplicated suspected concussion.', clinicalReasoning: 'Remove and assess first. Emergency referral is reserved for cases with red flag features such as LOC >1 minute, seizures, worsening headache/vomiting, focal neurological signs, or GCS <15.' },
              },
              {
                id: 'outcome-cleared',
                isOutcome: true,
                narrative: '',
                choices: [],
                outcome: { type: 'suboptimal', title: 'Normal SCAT6 Does Not Clear for Same-Day Return', explanation: 'Current consensus (Amsterdam 2022) states that an athlete with suspected concussion must NOT return to play on the same day, regardless of assessment results. Symptoms can evolve over hours.', clinicalReasoning: 'SCAT6 is a screening tool, not a diagnostic clearance instrument. A normal SCAT6 result does not rule out concussion — symptoms and cognitive deficits may emerge or worsen hours after the initial injury.' },
              },
              {
                id: 'outcome-optimal',
                isOutcome: true,
                narrative: '',
                choices: [],
                outcome: { type: 'optimal', title: 'Best Practice — No Same-Day Return', explanation: 'Correct. Current consensus (Amsterdam 2022) states that an athlete with suspected concussion must NOT return to play on the same day, regardless of assessment results. Symptoms can evolve over hours.', clinicalReasoning: 'The "no same-day return" rule is non-negotiable when concussion is suspected. The neurometabolic cascade is already underway and the brain is vulnerable. A normal SCAT6 at 20 minutes does not indicate full recovery — serial monitoring and a graduated return-to-play protocol are required.' },
              },
              {
                id: 'outcome-doctor',
                isOutcome: true,
      ...
      {moduleId === 1 && section.id === 'neuroanatomy-overview' && (
        <>
          <ClinicalInsight
            type="insight"
      ...
      {moduleId === 1 && section.id === 'mechanism-coup-contrecoup' && (
        <QuickCheck
      ...
      {moduleId === 1 && section.id === 'injury-classification' && (
        <QuickCheck
      ...
      {moduleId === 1 && section.id === 'biochemistry-overview' && (
        <>
          <KeyConcept
      ...
      {moduleId === 1 && section.id === 'imaging-clinical' && (
        <QuickCheck
      ...
      {moduleId === 2 && section.id === 'maddocks-questions' && (
        <QuickCheck
      ...
      {moduleId === 2 && section.id === 'glasgow-coma-scale' && (
        <QuickCheck
      ...
      {moduleId === 2 && section.id === 'severity-classification' && (
        <KeyConcept
      ...
      {moduleId === 2 && section.id === 'cranial-nerve-overview' && (
        <>
          <QuickCheck
      ...
      {moduleId === 2 && section.id === 'bess-sensory-integration' && (
        <QuickCheck
      ...
      {/* MODULE 3 */}
      {moduleId === 3 && section.id === 'voms-practical-procedure' && (
        <>
          <ClinicalInsight
            type="warning"
      ...
      {moduleId === 3 && section.id === 'bess-practical-procedure' && (
        <QuickCheck
      ...
      {moduleId === 3 && section.id === 'cervical-assessment-flowchart' && (
        <Flowchart
          title="Cervical Clearance Decision Pathway"
          steps={[
            { label: "Red Flag Screen", description: "Severe neck pain, neurological deficit, midline tenderness → Imaging before proceeding" },
            { label: "Canadian C-Spine Rule", description: "Age >65, dangerous mechanism, or paraesthesias → CT indicated" },
            { label: "Range of Motion", description: "Can patient actively rotate neck 45° left and right? If no → further investigation" },
            { label: "Cervicogenic Assessment", description: "Flexion-rotation test, joint position error, smooth pursuit neck torsion" },
            { label: "Clinical Decision", description: "Cleared for physiotherapy management vs. referral for imaging/specialist review" }
          ]}
        />
      )}

      {moduleId === 3 && section.id === 'cranial-nerve-practical' && (
        <QuickCheck
      ...
      {moduleId === 3 && section.id === 'oculomotor-dysfunction' && (
        <ClinicalInsight
          type="warning"
      ...
      {moduleId === 3 && section.id === 'acute-management-protocols' && (
        <KeyConcept
      ...
      {moduleId === 3 && section.id === 'clinical-checkpoints' && (
        <QuickCheck
      ...
      {moduleId === 5 && section.id === 'team-communication' && (
        <>
          <Flowchart
      ...
      {moduleId === 6 && section.id === 'rtp-progression-rules' && (
        <>
          <Flowchart
      ...
      {moduleId === 7 && section.id === 'migraine-rehab-detailed' && (
        <>
          <ClinicalInsight
            type="info"
      ...
      {/* Module 1: Clinical Scenarios & Exercises */}
      {moduleId === 1 && section.id === 'mechanism-coup-contrecoup' && (
        <ClinicalScenario
          ...
          steps={[
            {
              ...
              choices: [
                { label: 'Wait to see if symptoms develop before intervening', nextStepId: 'outcome-delayed' },
                { label: 'Immediately remove from play and begin structured sideline assessment', nextStepId: 'step-2' },
                { label: 'Ask the coach if the player seems okay to continue', nextStepId: 'outcome-deferred' },
              ],
            },
            {
              id: 'step-2',
              ...
              clinicalData: ['Mechanism: Lateral head impact (knee to right temporal region)', 'Observed: Dazed appearance, slow to rise', 'LOC: None observed'],
              choices: [
                { label: 'Focus only on the coup (right temporal) injury site', nextStepId: 'outcome-partial' },
                { label: 'Assess both coup (right) and contrecoup (left) regions plus rotational injury signs', nextStepId: 'outcome-optimal' },
              ],
            },
            {
              id: 'outcome-delayed',
      ...
      {moduleId === 1 && section.id === 'injury-classification' && (
        <OrderingExercise
          ...
          items={[
            { id: 'mild', label: 'Mild TBI (GCS 13-15)', rationale: 'Includes concussion. Brief or no LOC, confusion < 30 min.' },
            { id: 'moderate', label: 'Moderate TBI (GCS 9-12)', rationale: 'LOC 30 min-6 hours. Prolonged confusion and memory loss.' },
            { id: 'severe', label: 'Severe TBI (GCS 3-8)', rationale: 'LOC > 6 hours. Extensive damage, possible coma.' },
          ]}
          correctOrder={['mild', 'moderate', 'severe']}
      ...
      {moduleId === 1 && section.id === 'biochemistry-overview' && (
        <OrderingExercise
          ...
          items={[
            { id: 'mech', label: '1. Mechanical disruption of neuronal membranes', rationale: 'Immediate — biomechanical forces deform cell membranes and open mechanosensitive ion channels.' },
            { id: 'ionic', label: '2. Ionic flux (K+ out, Ca²+ in)', rationale: 'Seconds to minutes — potassium efflux and calcium influx disrupt membrane potential.' },
            { id: 'energy', label: '3. Energy crisis (ATP depletion)', rationale: 'Minutes to days — Na+/K+ pumps work overtime while cerebral blood flow decreases.' },
            { id: 'neuro', label: '4. Impaired neurotransmission', rationale: 'Hours to weeks — disrupted axonal transport and synaptic dysfunction.' },
            { id: 'calcium', label: '5. Calcium-mediated damage', rationale: 'Hours to days — excessive intracellular calcium triggers destructive enzyme pathways.' },
            { id: 'inflam', label: '6. Neuroinflammation', rationale: 'Hours to months — microglia activation and cytokine release.' },
            { id: 'recovery', label: '7. Recovery phase', rationale: 'Days to months — gradual restoration of ionic balance and metabolic function.' },
          ]}
          correctOrder={['mech', 'ionic', 'energy', 'neuro', 'calcium', 'inflam', 'recovery']}
      ...
      {moduleId === 1 && section.id === 'physiology-symptoms' && (
        <MatchingExercise
          ...
          pairs={[
            { id: 'cognitive', left: 'Cognitive dysfunction (memory, concentration)', right: 'Reduced cerebral blood flow + neuroinflammation', explanation: 'Decreased CBF and inflammatory mediators impair neural processing, particularly in frontal and temporal regions.' },
            { id: 'oculomotor', left: 'Oculomotor distress (visual tracking)', right: 'Autonomic nervous system impairment', explanation: 'ANS dysfunction affects pupillary control, accommodation, and smooth pursuit eye movements.' },
            { id: 'sleep', left: 'Sleep disturbance', right: 'Circadian rhythm + orexinergic disruption', explanation: 'Brainstem injury disrupts sleep-wake regulation, melatonin pathways, and GABA-mediated inhibition.' },
            { id: 'mood', left: 'Mood dysregulation (anxiety, irritability)', right: 'Limbic system + frontal lobe dysfunction', explanation: 'Disruption to the amygdala, hippocampus, and prefrontal cortex impairs emotional regulation and stress response.' },
          ]}
      ...
      {/* Module 2: Clinical Scenarios & Exercises */}
      {moduleId === 2 && section.id === 'loss-of-consciousness' && (
        <ClinicalScenario
          ...
          steps={[
            {
              ...
              clinicalData: ['Brief LOC (~5 seconds)', 'GCS on arrival: E4 V4 M6 = 14', 'No cervical spine tenderness on palpation'],
              choices: [
                { label: 'She recovered quickly — allow her to sit up and reassess in a few minutes', nextStepId: 'outcome-premature' },
                { label: 'Maintain cervical precautions, remove from play, complete full SCAT6 assessment', nextStepId: 'step-2' },
                { label: 'Immediately call an ambulance due to the LOC', nextStepId: 'outcome-overreact' },
              ],
            },
            {
              id: 'step-2',
              ...
              clinicalData: ['Maddocks: 3/5 correct', 'Missed: current score, last play', 'Alert and oriented to person and place'],
              choices: [
                { label: 'Failing Maddocks questions confirms concussion — no further testing needed', nextStepId: 'outcome-incomplete' },
                { label: 'This is suggestive of concussion — continue with full symptom evaluation and cognitive assessment', nextStepId: 'outcome-optimal' },
              ],
            },
            {
              ...
              narrative: '',
              choices: [],
              outcome: { type: 'suboptimal', title: 'Premature Decision', explanation: 'Any observed LOC mandates removal from play and comprehensive assessment, regardless of how quickly the player recovers.', clinicalReasoning: 'LOC is a significant concussion sign. Brief LOC does not indicate mild injury — the full neurometabolic cascade has been triggered regardless of LOC duration.' },
            },
            {
              ...
              narrative: '',
              choices: [],
              outcome: { type: 'acceptable', title: 'Cautious but Potentially Excessive', explanation: 'Brief LOC (<1 minute) with rapid GCS recovery typically does not require emergency transport. However, erring on the side of caution is always defensible.', clinicalReasoning: 'Ambulance is indicated for prolonged LOC (>1 min), declining GCS, focal neurological signs, or seizure. Brief LOC with rapid recovery warrants removal and full assessment but not necessarily emergency transport.' },
            },
            {
              ...
              narrative: '',
              choices: [],
              outcome: { type: 'acceptable', title: 'Incomplete Assessment', explanation: 'While Maddocks failure is highly suspicious for concussion, a complete assessment provides baseline data, documents severity, and guides management.', clinicalReasoning: 'Maddocks Questions are a rapid screening tool, not diagnostic on their own. Full SCAT6 includes symptom checklist, SAC (cognitive), modified BESS (balance), and neurological examination.' },
            },
            {
              id: 'outcome-optimal',
              isOutcome: true,
              narrative: '',
              choices: [],
              outcome: { type: 'optimal', title: 'Comprehensive Assessment', explanation: 'Continuing with full evaluation after suspicious Maddocks results is best practice — it documents the full clinical picture.', clinicalReasoning: 'Failed Maddocks Questions indicate post-traumatic amnesia (PTA) which is strongly suggestive of concussion. The complete SCAT6 provides a severity baseline and guides management decisions.' },
            },
          ]}
        />
      )}
      ...
      {moduleId === 2 && section.id === 'glasgow-coma-scale' && (
        <MatchingExercise
          ...
          pairs={[
            { id: 'eye', left: 'Eye Opening (E)', right: '1-4 points: Spontaneous, to voice, to pain, none', explanation: 'Eye opening reflects brainstem arousal function. Score ranges from 4 (spontaneous) to 1 (none).' },
            { id: 'verbal', left: 'Verbal Response (V)', right: '1-5 points: Oriented, confused, words, sounds, none', explanation: 'Verbal response assesses cortical function and language processing. Score ranges from 5 (oriented) to 1 (none).' },
            { id: 'motor', left: 'Motor Response (M)', right: '1-6 points: Obeys, localises, withdraws, flexion, extension, none', explanation: 'Motor response is the most reliable GCS component. Score ranges from 6 (obeys commands) to 1 (none).' },
          ]}
      ...
      {moduleId === 2 && section.id === 'symptom-assessment' && (
        <MultiSelectQuiz
      ...
      {/* Module 3: Clinical Scenarios & Exercises */}
      {moduleId === 3 && section.id === 'cervical-special-tests-detail' && (
        <ClinicalScenario
          ...
          steps={[
            {
              ...
              clinicalData: ['Headache: occipital, constant, 6/10 intensity', 'Neck ROM: Limited rotation bilaterally', 'No neurological deficits on screening'],
              choices: [
                { label: 'This is a primary concussion headache — prescribe cognitive rest', nextStepId: 'outcome-missed' },
                { label: 'Consider cervicogenic component — assess upper cervical spine (C0-C3)', nextStepId: 'step-2' },
                { label: 'Order cervical spine MRI before proceeding', nextStepId: 'outcome-premature-imaging' },
              ],
            },
            {
              id: 'step-2',
              ...
              clinicalData: ['Positive flexion-rotation test (limited to 28° bilaterally)', 'C2-C3 facet tenderness', 'Reproduced headache with sustained C1-C2 pressure'],
              choices: [
                { label: 'Cervicogenic headache confirmed — treat with cervical manual therapy alongside concussion management', nextStepId: 'outcome-optimal' },
                { label: 'Cervicogenic headache confirmed — treat neck only and discharge from concussion care', nextStepId: 'outcome-incomplete' },
              ],
            },
            {
              id: 'outcome-missed',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'suboptimal', title: 'Missed Cervicogenic Component', explanation: 'Headaches worsening with neck movement and limited cervical ROM strongly suggest a cervicogenic contribution. Pure concussion headaches are less affected by neck position.', clinicalReasoning: 'Up to 75% of concussion patients have concurrent cervical spine involvement. The upper cervical spine (C0-C3) shares innervation with the trigeminal nerve, making cervicogenic headache a common mimicker.' },
            },
            {
              id: 'outcome-premature-imaging',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'acceptable', title: 'Premature Imaging', explanation: 'While not wrong, clinical examination should precede imaging for post-concussion neck complaints without red flags. MRI is indicated if clinical findings suggest structural pathology.', clinicalReasoning: 'Clinical examination (flexion-rotation test, segmental assessment) is the gold standard for diagnosing cervicogenic headache and is more cost-effective than immediate imaging.' },
            },
            {
              id: 'outcome-optimal',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'optimal', title: 'Integrated Management', explanation: 'Excellent. Cervicogenic headache commonly co-exists with concussion and responds well to targeted cervical manual therapy as part of a comprehensive management plan.', clinicalReasoning: 'Schneider et al. (2017) demonstrated that cervicovestibular rehabilitation significantly improves concussion recovery times. Treating the cervical component often resolves "persistent" concussion symptoms.' },
            },
            {
              id: 'outcome-incomplete',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'acceptable', title: 'Siloed Management', explanation: 'While cervical treatment is appropriate, discharging from concussion care is premature. Concussion and cervicogenic symptoms often co-exist and should be managed together.', clinicalReasoning: 'Concurrent concussion management (graduated return to activity, symptom monitoring) should continue alongside cervical treatment. Both conditions share common mechanisms from the initial injury.' },
            },
          ]}
        />
      )}

      {moduleId === 3 && section.id === 'musculoskeletal-involvement' && (
        <OrderingExercise
          title="Cervical Assessment Protocol"
          instruction="Arrange these cervical assessment steps in the recommended clinical order."
          items={[
            { id: 'history', label: 'Take focused cervical history (mechanism, symptom pattern)', rationale: 'History guides the examination and identifies red flags requiring urgent referral.' },
            { id: 'rom', label: 'Assess active cervical range of motion', rationale: 'Active ROM identifies gross movement limitations and painful arcs before hands-on assessment.' },
            { id: 'flexrot', label: 'Perform cervical flexion-rotation test', rationale: 'Flexion-rotation test specifically assesses C1-C2 and has high sensitivity for cervicogenic headache.' },
            { id: 'segmental', label: 'Segmental palpation and joint assessment (C0-C3)', rationale: 'Identifies specific segmental dysfunction for targeted treatment.' },
            { id: 'neuro', label: 'Neurological screening (dermatomes, myotomes, reflexes)', rationale: 'Rules out neural compromise before proceeding with treatment.' },
          ]}
          correctOrder={['history', 'rom', 'flexrot', 'segmental', 'neuro']}
      ...
      {moduleId === 3 && section.id === 'case-scenario-integration' && (
        <MultiSelectQuiz
      ...
      {/* Module 4: Clinical Scenarios & Exercises */}
      {moduleId === 4 && section.id === 'pcs-pathophysiology' && (
        <ClinicalScenario
          ...
          steps={[
            {
              ...
              clinicalData: ['Symptoms: Daily headache (7/10), brain fog, fatigue, anxiety, poor sleep', 'Activity level: Minimal — stays home, avoids all stimulation', 'Mood: PHQ-9 score 14 (moderate depression)'],
              choices: [
                { label: 'Continue strict rest — 8 weeks is still early for some concussions', nextStepId: 'outcome-prolonged-rest' },
                { label: 'Prolonged rest is likely contributing to symptoms — initiate graduated return to activity', nextStepId: 'step-2' },
                { label: 'This must be post-concussion syndrome — refer to neurology only', nextStepId: 'outcome-delayed-referral' },
              ],
            },
            {
              id: 'step-2',
              ...
              choices: [
                { label: 'Subsymptom-threshold aerobic exercise, sleep hygiene, graduated cognitive activity, and psychology referral', nextStepId: 'outcome-optimal' },
                { label: 'Start with high-intensity exercise to "push through" the symptoms', nextStepId: 'outcome-aggressive' },
              ],
            },
            {
              id: 'outcome-prolonged-rest',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'suboptimal', title: 'Prolonged Rest', explanation: 'Strict rest beyond 48-72 hours is associated with worse outcomes. After 8 weeks, inactivity itself is likely a major symptom driver.', clinicalReasoning: 'Leddy et al. (2018) demonstrated that early subsymptom-threshold aerobic exercise accelerates recovery. Prolonged rest causes physical deconditioning, mood disturbance, and disrupted sleep — all of which mimic and amplify concussion symptoms.' },
            },
            {
              id: 'outcome-delayed-referral',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'acceptable', title: 'Incomplete Approach', explanation: 'Neurology referral may be appropriate, but primary management should address the modifiable factors maintaining symptoms.', clinicalReasoning: 'The biopsychosocial model of persistent symptoms recognises that biological injury, psychological factors (anxiety, depression, catastrophising), and social factors (isolation, role disruption) all contribute. Addressing modifiable factors should not wait for specialist review.' },
            },
            {
              id: 'outcome-optimal',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'optimal', title: 'Comprehensive Biopsychosocial Approach', explanation: 'Excellent. Addressing exercise tolerance, sleep, cognitive reactivation, and mood together targets the multifactorial nature of persistent symptoms.', clinicalReasoning: 'This approach addresses the energy crisis (graduated exercise improves cerebrovascular function), deconditioning (physical activity), mood (psychology, social reintegration), and sleep disruption simultaneously.' },
            },
            {
              id: 'outcome-aggressive',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'suboptimal', title: 'Overly Aggressive', explanation: 'High-intensity exercise in a symptomatic patient risks symptom exacerbation. Exercise should be subsymptom-threshold initially.', clinicalReasoning: 'The Buffalo Concussion Treadmill Test establishes symptom exacerbation threshold. Exercise prescription should start at 80% of this threshold and gradually progress.' },
            },
          ]}
        />
      )}
      ...
      {moduleId === 4 && section.id === 'treatment-strategies' && (
        <MatchingExercise
          ...
          pairs={[
            { id: 'headache', left: 'Cervicogenic headache', right: 'Cervical manual therapy + exercise', explanation: 'Schneider et al. demonstrated superior outcomes with cervicovestibular rehabilitation for cervicogenic headache post-concussion.' },
            { id: 'vestibular', left: 'Vestibular dysfunction (dizziness, imbalance)', right: 'Vestibular rehabilitation therapy', explanation: 'Canalith repositioning for BPPV; gaze stabilisation, habituation, and balance training for central vestibular dysfunction.' },
            { id: 'mood', left: 'Persistent mood disturbance', right: 'CBT + graduated activity exposure', explanation: 'Cognitive behavioural therapy addresses catastrophising and avoidance behaviours that maintain symptoms.' },
            { id: 'exercise', left: 'Exercise intolerance (autonomic dysfunction)', right: 'Subsymptom-threshold aerobic training (Buffalo Protocol)', explanation: 'Graduated aerobic exercise improves cerebrovascular autoregulation and autonomic function.' },
            { id: 'cognitive', left: 'Cognitive fatigue and processing speed', right: 'Graduated cognitive loading + compensatory strategies', explanation: 'Structured cognitive activity with pacing and breaks, combined with external memory aids and scheduling tools.' },
          ]}
          leftLabel="Symptom Domain"
      ...
      {/* Module 5: Clinical Scenarios & Exercises */}
      {moduleId === 5 && section.id === 'referral-pathways' && (
        <ClinicalScenario
          ...
          steps={[
            {
              ...
              choices: [
                { label: 'Refer to neurology and wait for specialist opinion before other referrals', nextStepId: 'outcome-sequential' },
                { label: 'Refer simultaneously to vestibular physiotherapy, optometry, and psychology', nextStepId: 'outcome-optimal' },
                { label: 'Manage everything yourself — you can treat all of these symptoms', nextStepId: 'outcome-solo' },
              ],
            },
            {
              id: 'outcome-sequential',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'acceptable', title: 'Sequential Referral', explanation: 'While neurology input may be valuable, waiting for specialist opinion before addressing vestibular, visual, and psychological symptoms delays recovery.', clinicalReasoning: 'Concurrent multidisciplinary management is more efficient. At 3 weeks post-injury, early intervention in modifiable symptom domains improves outcomes.' },
            },
            {
              id: 'outcome-optimal',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'optimal', title: 'Parallel Multidisciplinary Referral', explanation: 'Excellent. Simultaneous referral to relevant specialists addresses all symptom domains concurrently, reducing total recovery time.', clinicalReasoning: 'Each symptom domain requires domain-specific expertise: vestibular physiotherapy for positional dizziness, optometry for accommodative/convergence dysfunction, psychology for occupational anxiety. These treatments do not conflict and can proceed in parallel.' },
            },
            {
              id: 'outcome-solo',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'suboptimal', title: 'Scope of Practice Concerns', explanation: 'Managing all symptom domains alone exceeds most practitioners\' scope of practice and delays access to specialist interventions.', clinicalReasoning: 'Effective concussion management requires recognising the limits of individual scope and making timely referrals. The primary care role is coordination — not treating every domain independently.' },
            },
          ]}
        />
      )}

      {moduleId === 5 && section.id === 'phased-management-framework' && (
        <OrderingExercise
          title="Return-to-Activity Progression"
          instruction="Arrange these graduated return-to-sport stages in the correct order."
          items={[
            { id: 'rest', label: 'Symptom-limited activity (relative rest, 24-48h)', rationale: 'Brief rest followed by subsymptom-threshold activity.' },
            { id: 'light', label: 'Light aerobic exercise (walking, swimming)', rationale: 'Increases heart rate without head impact risk.' },
            { id: 'sport', label: 'Sport-specific exercise (running, skating)', rationale: 'Adds complexity and sport-specific movement patterns.' },
            { id: 'non-contact', label: 'Non-contact training drills', rationale: 'Increases cognitive load and coordination demands.' },
            { id: 'contact', label: 'Full-contact practice (after medical clearance)', rationale: 'Requires medical clearance before any contact.' },
            { id: 'return', label: 'Return to competition', rationale: 'Final stage — normal game play.' },
          ]}
          correctOrder={['rest', 'light', 'sport', 'non-contact', 'contact', 'return']}
      ...
      {moduleId === 5 && section.id === 'cultural-safety' && (
        <MultiSelectQuiz
      ...
      {/* Module 6: Clinical Scenarios & Exercises */}
      {moduleId === 6 && section.id === 'rtp-overview' && (
        <ClinicalScenario
          ...
          steps={[
            {
              ...
              clinicalData: ['Symptom-free for 48 hours', 'Completed Stages 1-4 without issues', 'Age: 16 (under 18)', 'Previous concussions: 0'],
              choices: [
                { label: 'He is symptom-free and has progressed through stages — clear for the grand final', nextStepId: 'outcome-premature' },
                { label: 'He needs to complete Stage 5 (full-contact practice) and medical clearance before return to competition', nextStepId: 'outcome-optimal' },
                { label: 'Under-18 athletes should wait a minimum of 4 weeks regardless of symptoms', nextStepId: 'outcome-over-cautious' },
              ],
            },
            {
              id: 'outcome-premature',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'suboptimal', title: 'Skipped Protocol Stage', explanation: 'Skipping Stage 5 (full-contact practice) means the athlete has not been tested under game-like conditions. Each protocol stage must be completed before advancing.', clinicalReasoning: 'Stage 5 (full-contact practice) exists specifically to test symptom response under contact conditions before competition exposure. Medical clearance is also required before any contact. The grand final timing does not change clinical requirements.' },
            },
            {
              id: 'outcome-optimal',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'optimal', title: 'Protocol-Compliant Decision', explanation: 'Correct. Full-contact practice (Stage 5) and formal medical clearance are required before return to competition, regardless of symptom resolution.', clinicalReasoning: 'The Amsterdam 2022 protocol mandates minimum 24 hours at each stage. For under-18 athletes, some guidelines recommend longer intervals. Medical clearance (not just self-report) is required before contact. Game importance does not influence clinical decisions.' },
            },
            {
              id: 'outcome-over-cautious',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'acceptable', title: 'Overly Conservative', explanation: 'While some organisations recommend extended timelines for youth, current guidelines do not mandate a fixed 4-week minimum. The protocol is symptom-guided, not time-based.', clinicalReasoning: 'The graduated protocol is individualised. Youth athletes may take longer at each stage, but there is no evidence-based mandate for a minimum 4-week wait if the protocol is completed without symptoms. However, conservative approaches are always defensible for youth athletes.' },
            },
          ]}
        />
      )}
      ...
      {moduleId === 6 && section.id === 'rtp-progression-rules' && (
        <OrderingExercise
          ...
          items={[
            { id: 'stage1', label: 'Stage 1: Symptom-limited activity (daily activities that do not provoke symptoms)', rationale: 'Gradual reintroduction of daily cognitive and physical activity.' },
            { id: 'stage2', label: 'Stage 2: Light aerobic exercise (walking, swimming, cycling <70% max HR)', rationale: 'No resistance training. Increases heart rate without impact or complex movements.' },
            { id: 'stage3', label: 'Stage 3: Sport-specific exercise (running drills, skating — no head impact)', rationale: 'Adds movement complexity. No contact or head impact risk activities.' },
            { id: 'stage4', label: 'Stage 4: Non-contact training drills (may start progressive resistance training)', rationale: 'Increases exercise intensity, adds coordination and cognitive load.' },
            { id: 'stage5', label: 'Stage 5: Full-contact practice (requires medical clearance)', rationale: 'Normal training activities — this is the first stage with contact.' },
            { id: 'stage6', label: 'Stage 6: Return to sport/competition', rationale: 'Normal game play. Player is fully cleared.' },
          ]}
          correctOrder={['stage1', 'stage2', 'stage3', 'stage4', 'stage5', 'stage6']}
      ...
      {/* Module 7: Clinical Scenarios & Exercises */}
      {moduleId === 7 && section.id === 'exercise-prescription' && (
        <ClinicalScenario
          ...
          steps={[
            {
              ...
              clinicalData: ['Symptom exacerbation threshold: 75% max HR (143 bpm)', 'Resting symptoms: Headache 3/10', 'Exercise history: Regular runner pre-injury'],
              choices: [
                { label: 'Prescribe exercise at exactly 75% max HR — the threshold', nextStepId: 'outcome-at-threshold' },
                { label: 'Prescribe exercise at 80% of the threshold (60% max HR / ~114 bpm)', nextStepId: 'outcome-optimal' },
                { label: 'No exercise until completely symptom-free', nextStepId: 'outcome-delayed' },
              ],
            },
            {
              id: 'outcome-at-threshold',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'suboptimal', title: 'Exercise at Threshold', explanation: 'Exercising at the exact symptom exacerbation point will consistently provoke symptoms and is counterproductive.', clinicalReasoning: 'The prescription should be at 80% of the threshold (subsymptom level) to allow cardiovascular benefit without symptom provocation. This means ~60% max HR in this case.' },
            },
            {
              id: 'outcome-optimal',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'optimal', title: 'Subsymptom-Threshold Prescription', explanation: 'Excellent. 80% of the symptom exacerbation threshold provides cardiovascular stimulus while staying below the symptom provocation point.', clinicalReasoning: 'Leddy et al. prescribe 80% of the Buffalo Treadmill Test threshold, 20-30 minutes, 5-6 days per week. Retest every 1-2 weeks and progress the threshold as it improves. Walking, stationary cycling, or swimming are preferred modalities.' },
            },
            {
              id: 'outcome-delayed',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'suboptimal', title: 'Unnecessary Delay', explanation: 'Current evidence strongly supports early subsymptom-threshold aerobic exercise. Waiting for full symptom resolution delays the therapeutic benefit of controlled exercise.', clinicalReasoning: 'Randomised controlled trials demonstrate that early aerobic exercise (within 2 weeks of injury) accelerates recovery compared to stretching-only or rest controls. Exercise improves cerebrovascular autoregulation and autonomic function.' },
            },
          ]}
        />
      )}

      {moduleId === 7 && section.id === 'ans-dysfunction' && (
        <MultiSelectQuiz
      ...
      {moduleId === 7 && section.id === 'vestibular-rehab-detailed' && (
        <OrderingExercise
          ...
          items={[
            { id: 'gaze', label: 'Gaze stabilisation (VOR x1) — stationary, head turns only', rationale: 'Foundational exercise targeting vestibulo-ocular reflex with minimal balance demand.' },
            { id: 'standing', label: 'Static balance exercises (feet together, eyes open)', rationale: 'Adds balance challenge while visual input is available.' },
            { id: 'foam', label: 'Balance on foam surface (altered somatosensory input)', rationale: 'Challenges balance by reducing somatosensory reliability.' },
            { id: 'dynamic', label: 'Dynamic balance with head turns (walking + VOR)', rationale: 'Combines locomotion with vestibular exercise — dual-task demand.' },
            { id: 'sport', label: 'Sport-specific balance challenges (uneven surfaces, reactive movements)', rationale: 'Highest level — prepares for return to sport demands.' },
          ]}
          correctOrder={['gaze', 'standing', 'foam', 'dynamic', 'sport']}
      ...
      {/* Module 8: Clinical Scenarios & Exercises */}
      {moduleId === 8 && section.id === 'duty-of-care' && (
        <ClinicalScenario
          ...
          steps={[
            {
              ...
              clinicalData: ['Observed: Significant head impact (shoulder to jaw)', 'Player reports: Mild dizziness, headache 3/10', 'Maddocks: 4/5 (missed one question)', 'Balance: Mild postural sway on tandem stance'],
              choices: [
                { label: 'Clear the player — symptoms are mild and he wants to play', nextStepId: 'outcome-cleared' },
                { label: 'Remove from play — clinical findings are consistent with concussion, regardless of external pressure', nextStepId: 'outcome-optimal' },
                { label: 'Allow the player to decide for himself whether to continue', nextStepId: 'outcome-deferred' },
              ],
            },
            {
              id: 'outcome-cleared',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'suboptimal', title: 'Duty of Care Breach', explanation: 'Clearing a player with active concussion symptoms and abnormal examination findings breaches your duty of care, regardless of symptom severity or player willingness.', clinicalReasoning: 'Clinical findings (failed Maddocks, postural sway, dizziness, headache) indicate concussion. Your legal and ethical obligation is to the patient, not the team. Returning a concussed athlete to play risks second impact syndrome and prolonged recovery.' },
            },
            {
              id: 'outcome-optimal',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'optimal', title: 'Duty of Care Upheld', explanation: 'Correct. Your duty of care is to the patient. Clinical findings consistent with concussion mandate removal from play regardless of external pressure.', clinicalReasoning: 'The Amsterdam 2022 consensus is clear: any suspected concussion = remove from play. The doctor-patient relationship takes precedence over the team-doctor contract. Document findings, communicate the decision clearly, and ensure appropriate follow-up.' },
            },
            {
              id: 'outcome-deferred',
              isOutcome: true, narrative: '', choices: [],
              outcome: { type: 'suboptimal', title: 'Abrogated Clinical Responsibility', explanation: 'A concussed athlete cannot make an informed decision about return to play. Concussion itself impairs judgment and decision-making.', clinicalReasoning: 'The medical practitioner is responsible for the clearance decision, not the patient. Cognitive impairment from concussion means the athlete cannot fully appreciate the risks. This is analogous to a patient under the influence of medication — their autonomy does not override clinical safety.' },
            },
          ]}
        />
      )}
      ...
      {moduleId === 8 && section.id === 'documentation-standards' && (
        <OrderingExercise
          ...
          items={[
            { id: 'history', label: 'Mechanism of injury and presenting complaint', rationale: 'Establish context — what happened, when, how, and what symptoms are present.' },
            { id: 'exam', label: 'Clinical examination findings (neurological, cervical, VOMS, BESS)', rationale: 'Document objective assessment findings using standardised tools.' },
            { id: 'diagnosis', label: 'Clinical impression / diagnosis', rationale: 'State your clinical conclusion based on history and examination.' },
            { id: 'plan', label: 'Management plan (treatment, activity modification, referrals)', rationale: 'Document agreed management, including restrictions and referral rationale.' },
            { id: 'education', label: 'Patient education provided and consent obtained', rationale: 'Record what information was given, that it was understood, and consent obtained.' },
            { id: 'followup', label: 'Follow-up plan and safety-netting advice', rationale: 'Document when to return, red flag symptoms to watch for, and emergency contact details.' },
          ]}
          correctOrder={['history', 'exam', 'diagnosis', 'plan', 'education', 'followup']}
      ...
      {/* Module 1: Secondary Injury — critical classification content with no interactive */}
      {moduleId === 1 && section.id === 'secondary-injury' && (
        <>
          <QuickCheck
      ...
      {/* Module 2: Nystagmus Detailed — 25 content items with no interactive */}
      {moduleId === 2 && section.id === 'nystagmus-detailed' && (
        <QuickCheck
      ...
      {/* Module 4: DMN Dysfunction — 26 content items with no interactive */}
      {moduleId === 4 && section.id === 'dmn-dysfunction' && (
        <QuickCheck
      ...
      {/* Module 6: Neurocognitive Testing — 52 content items with no interactive */}
      {moduleId === 6 && section.id === 'neurocognitive-testing' && (
        <QuickCheck
      ...
      {/* Module 7: ANS Clinical Case — 25 content items with no interactive */}
      {moduleId === 7 && section.id === 'ans-clinical-case' && (
        <QuickCheck
      ...
      {/* Module 2: Grading Systems — bare content section */}
      {moduleId === 2 && section.id === 'grading-systems' && (
        <QuickCheck
      ...
      {/* Module 2: Severity Timeline — bare content section */}
      {moduleId === 2 && section.id === 'severity-timeline' && (
        <QuickCheck
      ...
      {/* Module 2: Cervical Assessment — bare content section */}
      {moduleId === 2 && section.id === 'cervical-assessment' && (
        <QuickCheck
      ...
      {/* Module 2: Upper Cervical Syndrome — bare content section */}
      {moduleId === 2 && section.id === 'upper-cervical-syndrome' && (
        <QuickCheck
      ...
      {/* Module 4: CTE Pathophysiology — bare content section */}
      {moduleId === 4 && section.id === 'cte-pathophysiology' && (
        <QuickCheck
      ...
      {/* Module 4: CTE Current Evidence — bare content section */}
      {moduleId === 4 && section.id === 'cte-current-state' && (
        <QuickCheck
      ...
      {/* Module 4: Long-Term Outcomes — bare content section */}
      {moduleId === 4 && section.id === 'long-term-outcomes' && (
        <QuickCheck
      ...
      {/* Module 1: Imaging Research — bare content section (updated) */}
      {moduleId === 1 && section.id === 'imaging-research' && (
        <MultiSelectQuiz
          question="Which imaging modalities are used in ROUTINE clinical practice for concussion? (Select all that apply)"
          options={['CT scan', 'Standard MRI', 'fMRI', 'Diffusion Tensor Imaging (DTI)', 'Magnetic Resonance Spectroscopy (MRS)', 'SPECT']}
          correctAnswers={[0, 1]}
      ...
      {/* Module 1: Biomarkers Overview — bare content section (updated) */}
      {moduleId === 1 && section.id === 'biomarkers-overview' && (
        <QuickCheck
          question="Which biomarker received FDA clearance in 2018 as the first blood test to aid concussion evaluation?"
          options={["S100B", "GFAP and UCH-L1 (Banyan BTI)", "Tau protein", "Neurofilament light (NfL)"]}
          correctAnswer={1}
      ...
      {/* Module 1: Identifiable Pathology — bare content section (updated) */}
      {moduleId === 1 && section.id === 'identifiable-pathology' && (
        <QuickCheck
          question="Diffuse axonal injury (DAI) is BEST detected by which imaging modality?"
          options={["Standard CT scan", "Plain X-ray", "Diffusion Tensor Imaging (DTI)", "Standard MRI"]}
          correctAnswer={2}
      ...
      {/* Module 5: Neurology Role — bare content section */}
      {moduleId === 5 && section.id === 'neurology-role' && (
        <QuickCheck
      ...
      {/* Module 5: Case Example Multidisciplinary — bare content section */}
      {moduleId === 5 && section.id === 'case-example-multidisciplinary' && (
        <ClinicalScenario
          ...
          steps={[
            {
              ...
              choices: [
                ...
                { label: 'Neurology first — 3 weeks of persistent symptoms warrants specialist investigation', nextStepId: 'step-2-neuro' },
              ],
            },
            {
              id: 'step-2-psych',
              ...
              clinicalData: ['PHQ-9 likely reactive rather than primary', 'Vestibular and cervicogenic symptoms continue to limit daily function', 'Patient increasingly frustrated with missing school'],
              choices: [
                { label: 'Refer to vestibular physio AND initiate return-to-learn accommodations simultaneously', nextStepId: 'outcome-acceptable' },
                { label: 'Wait for psychology treatment to progress before adding more appointments', nextStepId: 'outcome-suboptimal-wait' },
                { label: 'Refer to all remaining specialists at once — neurology, vestibular physio, optometry', nextStepId: 'outcome-suboptimal-flood' },
              ],
            },
            {
              id: 'step-2-vestib',
              ...
              clinicalData: ['Dizziness improving with vestibular rehab', 'Neck pain persisting — cervicogenic component untreated', 'PHQ-9 now 15 — mood worsening', 'Still missing school'],
              choices: [
                { label: 'Add cervicogenic physiotherapy, psychology referral, AND initiate return-to-learn plan — coordinate all providers', nextStepId: 'outcome-optimal' },
                { label: 'Continue vestibular rehab only — address one issue at a time', nextStepId: 'outcome-suboptimal-serial' },
                { label: 'Refer to neurology for comprehensive workup before adding more therapists', nextStepId: 'outcome-acceptable-neuro' },
              ],
            },
            {
              id: 'step-2-neuro',
              ...
              clinicalData: ['Neurology confirms PPCS — no additional pathology', 'Recommends vestibular rehab, cervicogenic physio, psychology', 'Patient has been waiting 2 weeks for neurology appointment — now 5 weeks post-injury'],
              choices: [
                { label: 'Refer to vestibular physio, cervicogenic physio, and psychology simultaneously with shared care plan', nextStepId: 'outcome-acceptable-delayed' },
                { label: 'Start with vestibular physio only and add specialists sequentially', nextStepId: 'outcome-suboptimal-serial' },
                { label: 'Begin all referrals AND establish return-to-learn accommodations with the school', nextStepId: 'outcome-optimal-delayed' },
              ],
            },
            {
              id: 'outcome-optimal',
      ...
      {/* Module 6: Workplace Accommodations — bare content section */}
      {moduleId === 6 && section.id === 'workplace-accommodations' && (
        <QuickCheck
      ...
      {/* Module 6: Case Studies Return — bare content section */}
      {moduleId === 6 && section.id === 'case-studies-return' && (
        <ClinicalScenario
          title="Return to Play Decision"
          ...
          steps={[
            {
              ...
              clinicalData: ['Day 10 post-concussion', 'Symptom-free at rest for 48 hours', 'Completed Stage 2 (light aerobic exercise) without symptoms', 'Coach requesting expedited clearance for finals', '16-year-old — paediatric RTP protocol applies'],
              choices: [
                { label: 'Clear for full contact practice — symptom-free and tolerating exercise', nextStepId: 'outcome-premature-clear' },
                { label: 'Continue graduated RTP protocol — minimum 24 hours per stage, no stages can be skipped', nextStepId: 'step-2' },
                { label: 'Hold all activity for another week to be safe, then reassess', nextStepId: 'outcome-overcautious' },
              ],
            },
            {
              id: 'step-2',
              ...
              clinicalData: ['Stage 3 completed — sport-specific drills, no symptoms', 'Stage 4 completed — non-contact training, no symptoms', 'Now Day 12 post-concussion', 'Finals in 5 days'],
              choices: [
                { label: 'Proceed to Stage 5 (full contact practice) and clear for finals if tolerated', nextStepId: 'outcome-skip-medical' },
                { label: 'Medical clearance assessment required before Stage 5 — then full contact practice, then match play (Stage 6)', nextStepId: 'step-3' },
                { label: 'Clear directly to match play — patient has shown progression through all stages', nextStepId: 'outcome-premature-clear' },
              ],
            },
            {
              id: 'step-3',
              ...
              clinicalData: ['Stage 5 (full contact practice) completed without symptoms', 'Medical clearance obtained', 'Day 14 post-concussion', 'Finals in 3 days'],
              choices: [
                { label: 'Verbal clearance to coach is sufficient — the player is ready', nextStepId: 'outcome-poor-documentation' },
                { label: 'Written medical clearance documenting: all RTP stages completed, dates/duration per stage, clinical assessment findings, and informed consent discussion with player and parents', nextStepId: 'outcome-optimal' },
                { label: 'Email the coach confirming clearance — no formal documentation needed for return to sport', nextStepId: 'outcome-poor-documentation' },
              ],
            },
            {
              id: 'outcome-optimal',
      ...
      {/* Module 7: Mood Rehab Detailed — bare content section */}
      {moduleId === 7 && section.id === 'mood-rehab-detailed' && (
        <QuickCheck
      ...
      {/* Module 8: Case Documentation Legal — bare content section */}
      {moduleId === 8 && section.id === 'case-documentation-legal' && (
        <ClinicalScenario
          ...
          steps={[
            {
              ...
              clinicalData: ['Request from employer\'s insurer for "all clinical records"', 'Patient has disclosed anxiety and relationship stress in sessions', 'Clinical notes contain both concussion-related and personal disclosures', '8 weeks of treatment records'],
              choices: [
                { label: 'Release all clinical records as requested — the insurer has a right to medical information for the claim', nextStepId: 'outcome-breach' },
                { label: 'Discuss the request with the patient, explain what records exist, and obtain informed consent before releasing anything', nextStepId: 'step-2' },
                { label: 'Refuse the request entirely — clinical records are always confidential', nextStepId: 'outcome-obstructive' },
              ],
            },
            {
              id: 'step-2',
              ...
              clinicalData: ['Patient consents to concussion-related information being shared', 'Patient does NOT consent to personal/relationship disclosures being shared', 'Insurer request was broad — "all clinical records"'],
              choices: [
                { label: 'Release only concussion-related records and note that the patient has limited consent to concussion-related information only', nextStepId: 'step-3' },
                { label: 'Tell the patient they must consent to full release or the claim may be affected', nextStepId: 'outcome-coercive' },
                { label: 'Redact the personal information from the records and send everything else', nextStepId: 'outcome-acceptable-redact' },
              ],
            },
            {
              id: 'step-3',
              ...
              clinicalData: ['Limited consent obtained — concussion-related information only', 'Need to provide meaningful clinical information for the claim', 'Must protect patient confidentiality for non-consented disclosures'],
              choices: [
                { label: 'Send a copy of the clinical notes with personal sections blacked out', nextStepId: 'outcome-acceptable-redact' },
                { label: 'Prepare a structured medicolegal report: injury details, diagnosis, treatment provided, functional status, prognosis, and return-to-work recommendations — without personal disclosures', nextStepId: 'outcome-optimal' },
                { label: 'Write a brief letter stating the patient had a concussion and is recovering — minimal detail to protect privacy', nextStepId: 'outcome-insufficient' },
              ],
            },
            {
              id: 'outcome-optimal',
