  ...
  return (
    <section className="mb-10" data-track-section="streams">
      ...
      <p className="text-[11px] text-muted-foreground mt-4 inline-flex items-center gap-1.5">
        <Lock className="w-3 h-3" /> Preview of the live clinic portal · two streams, one Concussion Clinical Mastery practical day. Each stream is {CONFIG.COURSE.ONLINE_CPD_POINTS} hrs online CPD; the shared practical day adds {CONFIG.COURSE.IN_PERSON_CPD_POINTS} — {CONFIG.COURSE.TOTAL_CPD_POINTS} CPD hours total.
      </p>
    </section>
  )
}
