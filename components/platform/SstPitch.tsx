...
const CONFIG: Record<SstPitchVariant, VariantConfig> = {
  ...
  acc: {
    ...
    subhead:
      'A measured sub-threshold aerobic programme where every home session is a functional outcome — producing an ACC-ready report with the clause 5.4.7 “reviewed during delivery” evidence built in, for you to file against the claim.',
    heroChips: ['Functional measure — not symptom logging', 'ACC 5.4.7 evidence, generated automatically', 'Designed to write into Gensolve — in certification'],
    ...
    solutions: [
      ...
      { icon: '🗂', title: 'An ACC-ready report for the claim', body: 'The report carries the ACC45 claim reference and the functional outcome, formatted to file against the claim. Automatic filing into Gensolve is in certification.' },
    ...
    proof: ['Designed to ESSA standards', 'A claim-ready report today; Gensolve filing in certification', 'Send to a clinical or service lead — this is a workflow, not a referral'],
    closingTitle: 'The functional measure your evaluation said was missing.',
    closingBody: 'Fifteen minutes with a clinical lead and I’ll walk the ACC-ready report and the 5.4.7 evidence on a sample episode.',
  },
  guild: {
