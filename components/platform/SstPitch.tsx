...
const CONFIG: Record<SstPitchVariant, VariantConfig> = {
  clinics: {
    ...
    subhead:
      'Sub-threshold aerobic rehab happens at home, most days of the week — where you can’t tell whether they hit the right heart rate or bailed early. SST Trainer streams every home session to your dashboard, and drafts the GP letter for you.',
    heroChips: ['Measured Buffalo-protocol threshold', 'Live HR from the patient’s own watch', 'Built for Cliniko — completing certification'],
    ...
    solutions: [
      ...
      { icon: '📄', title: 'The GP letter drafts itself into Cliniko', body: 'At episode end the report writes itself — trajectory, adherence, clearance-or-extend recommendation — as a note in the patient’s Cliniko file for you to review and sign.' },
    ],
    proof: ['Osteopathy Australia–endorsed concussion CPD sits alongside the tool', 'Built for Cliniko — completing certification', 'Clinician-directed: the tool presents data and paces the protocol; you decide'],
    closingTitle: 'Put every patient’s trajectory on your dashboard.',
    closingBody: 'Fifteen minutes and I’ll show you the between-visit view for a single patient, and the report it writes into Cliniko.',
  },
  acc: {
    eyebrow: 'For NZ ACC concussion services',
    headlineLead: 'The 5.4.7 evidence,',
    headlineAccent: 'generated as you deliver.',
    subhead:
      'A measured sub-threshold aerobic programme where every home session is a functional outcome — written into Gensolve against the ACC45 claim, with the “reviewed during delivery” evidence accumulating automatically.',
    heroChips: ['Writes into Gensolve against the ACC45 claim', 'Functional measure — not symptom logging', 'Built for Gensolve — completing certification'],
    ctaLabel: 'Show a clinical lead',
    ctaHref: MAILTO('SST Trainer — ACC concussion reporting', 'Hi Zac — I’d like a 15-minute look at the ACC-claim view and the 5.4.7 evidence for our service.'),
    secondaryLabel: 'See how the trainer works →',
    secondaryHref: '/sst-trainer',
    showDemo: true,
    painTitle: 'The documentation ACC requires — by hand.',
    painBody:
      'Your contract requires evidence that outcome measures were reviewed during delivery (clause 5.4.7), and a functional rather than symptom-led focus. Capturing that mid-delivery, by hand, is the part that eats admin time — and it’s the exact gap the ACC-funded evaluation of the sector named: no PMS integration, and outcome measurement skewed to symptoms over function.',
    ...
    solutions: [
      ...
      { icon: '🗂', title: 'Written into the ACC45 claim', body: 'The report resolves the patient’s ACC condition and writes the outcome note against the funded ACC45 claim in Gensolve — not a detached document store.' },
      { icon: '✔', title: 'Clause 5.4.7, automatically', body: 'Every graded re-test is a formal review point; the report prints the “measures reviewed during delivery” evidence as a by-product of care.' },
    ...
    proof: ['Designed to ESSA standards', 'Built for Gensolve — completing certification', 'Send to a clinical or service lead — this is a workflow, not a referral'],
    closingTitle: 'The functional measure your evaluation said was missing.',
    closingBody: 'Fifteen minutes with a clinical lead and I’ll walk the ACC45 write-back and the 5.4.7 evidence on a sample episode.',
  },
  guild: {
