...
const buildFaqs = (accredited: boolean): FaqItem[] => [
  ...
  },
  {
    ...
    a: 'Yes — most practices and employers cover CPD training costs. Your tax invoice is issued with payment, so you can submit it for reimbursement straight away; the CPD certificate follows on completion. Many practitioners pay nothing out of pocket.',
  },
]
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className={`stream-body max-w-6xl mx-auto px-6 pb-12 md:pb-20 ${hideNav ? 'pt-6' : 'pt-[120px]'}`}>
        ...
        <div id="pricing-cards" className="mt-6">
          {/* THE SHARED BENTO — same component as the CCM tab, stream-parameterized
        ...
        <div className="max-w-3xl mx-auto mb-6 p-4 rounded-xl bg-blue-50 border border-blue-200 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">Your employer or practice likely covers CPD training costs. Tax invoice with payment · CPD certificate on completion.</p>
          </div>
        </div>
