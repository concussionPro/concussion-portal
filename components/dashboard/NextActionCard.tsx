...
export function NextActionCard() {
  ...
  if (!nextModule) {
    return (
      <div className="glass rounded-2xl border-2 border-accent/30 p-6 mb-8 relative overflow-hidden">
        <div className="flex items-start gap-4">
          <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-accent to-accent/80 flex items-center justify-center flex-shrink-0 shadow-md">
  ...
  return (
    <div className="glass rounded-2xl border-2 border-accent/20 p-6 mb-8 relative overflow-hidden hover:border-accent/30 transition-all group">
      <div className="flex items-start gap-4">
        {/* Module Number Badge */}
        <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-accent to-accent/80 flex items-center justify-center flex-shrink-0 shadow-md">
