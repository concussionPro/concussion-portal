...
export const OUTREACH_TEMPLATES: OutreachTemplate[] = [
  ...
  {
    slug: 'surf-life-saving-partnership',
    title: 'Surf Life Saving Club Partnership',
    audience: 'Surf life saving club captain / chief instructor',
    purpose: 'Offer concussion management partnership to surf life saving clubs (board strikes, surf-related head impacts, junior nipper programs).',
    channel: 'email',
    ...
    sections: [
      {
        ...
        body: [
          'Hi {captain_name},',
          'Concussion in surf life saving is under-recognised — board strikes, wipe-out impacts, and contact during patrol drills can all cause concussion that doesn\'t always present obviously.',
          '{clinic_name} is now a concussion-trained allied health clinic, and we\'re reaching out to {club_name} ahead of the {season_year} patrol season.',
          'What we can offer:',
          '• Same-week assessment for any member after a suspected concussion (junior nippers through to senior patrollers).',
          '• Written return-to-water and return-to-patrol certification.',
          '• A brief in-person session for senior patrol members on concussion recognition — sideline-equivalent for surf life saving contexts.',
          '• Direct clinician contact for uncertain presentations.',
          'Would a quick 10-minute call work? Happy to come down to a Sunday patrol or training session.',
          'Cheers,',
          '{clinician_name} · {clinic_name} · {clinic_phone}',
        ],
      },
  ...
  {
    slug: 'triathlon-cycling-club-outreach',
    title: 'Triathlon / Cycling Club Outreach',
    audience: 'Triathlon / cycling club president, head coach',
    purpose: 'Position clinic as the concussion management resource for the cycling and triathlon community (crash-related head impact).',
    channel: 'email',
    subject: 'Cycling crash concussion — support for {club_name}',
    sections: [
      {
        heading: 'Email body',
        body: [
          'Hi {coach_name},',
          'Cycling crashes are the most under-recognised cause of concussion in adult endurance sport — helmet impact frequently produces concussion even when there\'s no obvious external injury.',
          '{clinic_name} is concussion-trained and we\'re building referral relationships with local cycling and triathlon clubs.',
          'What we offer your members:',
          '• Same-week assessment after any crash with helmet impact, regardless of helmet condition.',
          '• Graduated return-to-training plan that respects the cardiovascular load profile of endurance athletes (the Buffalo Concussion Treadmill Test is specifically designed for this).',
          '• Return-to-racing certification.',
          '• Brief on common cycling crash concussion patterns for your senior squad.',
          'A 10-minute call to see if there\'s a fit? Happy to drop into a club training session.',
          'Regards,',
          '{clinician_name} · {clinic_name} · {clinic_phone}',
        ],
      },
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          '4. Surf Life Saving Partnership.',
          '5. Triathlon / Cycling Club Outreach.',
