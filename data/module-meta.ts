...
const scatModules: SCATModuleMeta[] = [
  ...
  },
  {
    ...
    duration: '20 min',
    points: 0,
    description: 'Four detailed clinical case studies designed to consolidate your course learning. Each case walks through a complete clinical scenario — from initial assessment to documentation, decision-making, and disposition.',
    isFree: true,
  },
]
