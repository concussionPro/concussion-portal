...
export const module8: Module = {
  ...
  clinicalReferences: [
    ...
    'Exercise & Sports Science Australia (ESSA). Code of Professional Conduct and Ethical Practice; and National Alliance of Self-Regulating Health Professions (NASRHP). Standards — clinical records: requirements for accurate, contemporaneous, legible and securely stored records (benchmark for self-regulated exercise physiology practice).',
