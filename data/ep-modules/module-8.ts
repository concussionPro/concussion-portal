...
export const module8: Module = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        '   - Apply sound record-keeping and privacy standards consistent with ESSA\'s Code of Professional Conduct and Ethical Practice, NASRHP self-regulation standards and the Australian Privacy Principles.',
    ...
    },
    {
      ...
      content: [
        ...
        'A practical efficiency note: if you use the at-home tool described in your toolkit, it logs each session — the heart-rate, workload and symptom data you then carry into these documents, which you complete and sign yourself (the record remains yours). It saves you reconstructing the numbers, not the clinical authorship; every document here is completed from the templates in your toolkit.',
      ],
    },
  ],
  quiz: [
  ...
  clinicalReferences: [
    ...
    'Office of the Australian Information Commissioner. (n.d.). Australian Privacy Principles, Privacy Act 1988 (Cth): handling of health information (APP 8 — cross-border disclosure; APP 11 — data security). OAIC. https://www.oaic.gov.au',
    ...
    'Australian Institute of Sport, & Australian Medical Association. (2024). Concussion and brain health position statement 2024. Australian Sports Commission. https://www.concussioninsport.gov.au',
  ],
}
