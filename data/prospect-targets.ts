...
export const PROSPECT_TARGETS: ProspectSeed[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────
  {
    ...
    travelBand: 'within-2hr', cohortRecommendation: 'essential',
    status: 'archived', priorityWave: 'P1', pitchVariant: 'metro',
    notes: 'ARCHIVED — only 5 clinical (below 8-clinician on-site threshold).',
  },
  {
  ...
  // ─────────────────────────────────────────────────────────────────────
  {
    ...
    notes: 'ARCHIVED — paediatric-focused, single-disc (physio only). Wrong segment.',
  },
  {
  ...
  },
  {
    ...
    travelBand: 'within-4hr', cohortRecommendation: 'essential',
    status: 'archived', priorityWave: 'P2', pitchVariant: 'network', networkSize: 2,
    notes: 'ARCHIVED — physio + podiatry only, not multi-disc enough for on-site cohort.',
  },
  {
  ...
  },
  {
    ...
    travelBand: 'within-4hr', cohortRecommendation: 'essential',
    status: 'archived', priorityWave: 'P2', pitchVariant: 'metro',
    notes: 'ARCHIVED — only 4 clinical (too small for on-site cohort).',
  },
  {
  ...
  },
  {
    ...
    notes: 'ARCHIVED — 9 physios but single-disc (no EP/osteo/sports-med).',
  },
  {
    ...
    travelBand: 'within-10hr', cohortRecommendation: 'essential',
    status: 'archived', priorityWave: 'P3', pitchVariant: 'regional', nearestMetro: 'Sydney',
    notes: 'ARCHIVED — only 5 clinical (too small).',
  },
  {
  ...
  // ─────────────────────────────────────────────────────────────────────
  {
    ...
    contactEmail: 'aaron@mncphysio.com.au', contactEmailSource: 'pattern-guess',
    contactRole: 'Managing Principal',
    contactDiscipline: 'physiotherapists',
    ...
    travelBand: 'within-4hr', cohortRecommendation: 'full-team',
    status: 'researching', priorityWave: 'P4', pitchVariant: 'network', networkSize: 9, nearestMetro: 'Sydney',
    notes: 'VERIFIED. Aaron Hardaker Managing Principal. 50 staff. 9 sites Woolgoolga-Laurieton. NOTE: original aaron@mncalliedhealth.com.au bounced — real email lives on his physio brand domain mncphysio.com.au. Likely pattern aaron@mncphysio.com.au; verify by phone before re-send.',
  },
  {
  ...
  },
  {
    ...
    notes: 'ARCHIVED — only 6 clinical (below threshold for full-team on-site).',
  },
  {
  ...
  },
  {
    ...
    travelBand: 'within-4hr', cohortRecommendation: 'essential',
    status: 'archived', priorityWave: 'P3', pitchVariant: 'regional', nearestMetro: 'Sydney',
    notes: 'ARCHIVED — only 6 clinical (below threshold).',
  },
  {
    ...
    travelBand: 'flight-far', cohortRecommendation: 'recommended',
    status: 'archived', priorityWave: 'P5', pitchVariant: 'regional', nearestMetro: 'Brisbane',
    notes: 'ARCHIVED — 10 physios single-disc + Townsville flight uneconomic for on-site.',
  },
  ...
  },
  {
    ...
    notes: 'ARCHIVED — 5 physios single-disc + Adelaide travel uneconomic.',
  },
  {
